    ...
    return [
      {
        ...
        data: {
          name:
            (await this.dashBoardService.find('overdue')) <= 1
              ? 'Order'
              : 'Orders',
          count: await this.dashBoardService.find('overdue'),
          extra: {
            name: '',
            count: '',
          },
      ...
      },
      {
        ...
        data: {
          name: 'Orders',
          count: await this.dashBoardService.find('active'),
          extra: {
            name: '',
            count: '',
          },
      ...
      },
      {
        ...
        data: {
          name: 'Orders',
          count: await this.dashBoardService.find('total'),
          extra: {
            name: 'Closed today',
            count: 0,
          },
