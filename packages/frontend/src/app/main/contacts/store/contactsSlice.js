...
export const removeContact = createAsyncThunk(
	...
	async (_id, { dispatch, getState }) => {
		await axios.post(`${process.env.REACT_APP_API_URL}/contacts/delete`, { _id });
...
export const removeContacts = createAsyncThunk(
	...
	async (contactIds, { dispatch, getState }) => {
		await axios.post(`${process.env.REACT_APP_API_URL}/remove-contact`, { contactIds });
...
export const toggleStarredContact = createAsyncThunk(
	...
	async (contactId, { dispatch, getState }) => {
		const response = await axios.post(`${process.env.REACT_APP_API_URL}/toggle-starred-contact`, { contactId });
		const data = await response.data;
...
export const toggleStarredContacts = createAsyncThunk(
	...
	async (contactIds, { dispatch, getState }) => {
		const response = await axios.post(process.env.REACT_APP_API_URL + '/toggle-starred-contacts', { contactIds });
		const data = await response.data;
...
export const setContactsStarred = createAsyncThunk(
	...
	async (contactIds, { dispatch, getState }) => {
		const response = await axios.post(process.env.REACT_APP_API_URL + '/set-contacts-starred', { contactIds });
		const data = await response.data;
...
export const setContactsUnstarred = createAsyncThunk(
	...
	async (contactIds, { dispatch, getState }) => {
		const response = await axios.post(process.env.REACT_APP_API_URL + '/set-contacts-unstarred', { contactIds });
		const data = await response.data;
